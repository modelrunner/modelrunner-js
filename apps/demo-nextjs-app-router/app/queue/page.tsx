...
const DEFAULT_ENDPOINT_ID = "modelrunner/fast-sdxl";
const DEFAULT_INPUT = `{
...
export default function Home() {
  ...
  const run = async () => {
    ...
    try {
      const result = await modelrunner.subscribe(endpointId, {
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
      <main className="container flex w-full flex-1 flex-col items-center justify-center space-y-8 py-10 text-gray-900 dark:text-gray-50">
        <h1 className="mb-8 text-4xl font-bold">
          <code className="font-light text-pink-600">modelrunner</code>
          <code>queue</code>
        </h1>
