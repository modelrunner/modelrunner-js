...
import { createModelrunnerClient, Result } from "@modelrunner/client";
...
export default function ComfyImageToVideoPage() {
  ...
  const generateVideo = async () => {
    ...
    try {
      const { data }: Result<ComfyOutput> = await modelrunner.subscribe(
        "comfy/modelrunner/image-to-video",
        {
          input: {
