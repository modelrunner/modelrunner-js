...
export type ModelrunnerHonoProxyOptions = {
  /**
   * A function to resolve the API key used by the proxy.
   * By default, it uses the `MODELRUNNER_KEY` environment variable.
   */
...
/**
 * Creates a route handler that proxies requests to the modelrunner API.
 *
...
}: ModelrunnerHonoProxyOptions): RouteHandler {
