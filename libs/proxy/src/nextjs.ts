...
/**
 * The default Next API route for the modelrunner.ai client proxy.
 */
export const PROXY_ROUTE = DEFAULT_PROXY_ROUTE;

/**
 * The Next API route handler for the modelrunner.ai client proxy.
...
/**
 * The Next API route handler for the modelrunner.ai client proxy on App Router apps.
 *
 * @param request the Next API request object.
 * @returns a promise that resolves when the request is handled.
 */
