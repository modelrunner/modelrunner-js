...
export type StreamOptions<Input> = {
  ...
  /**
   * Whether it should auto-upload File-like types to modelrunner's storage
   * or not.
   */
  ...
  private start = async () => {
    ...
    try {
      if (connectionMode === "client") {
        ...
        parsedUrl.searchParams.set("modelrunner_jwt_token", token);
...
export interface StreamingClient {
  /**
   * Calls a modelrunner app that supports streaming and provides a streaming-capable
